...
if not os.getenv("OPENAI_API_KEY") and not os.getenv("GEMINI_API_KEY") and not os.getenv("HUGGINGFACEHUB_API_TOKEN"):
    st.error("Please set either OPENAI_API_KEY, GEMINI_API_KEY, or HUGGINGFACEHUB_API_TOKEN in your .env file.")
    st.stop()
